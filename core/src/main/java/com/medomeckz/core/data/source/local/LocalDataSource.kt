package com.medomeckz.core.data.source.local

import com.medomeckz.core.data.source.local.entity.UserEntity
import com.medomeckz.core.data.source.local.room.UserDao
